...
- The local Compose stack contains ERPBridge, Mock ERP, and Redis only
  ...
  specified separately in `../completed/[COMPLETED]Plan-Mock-ERP.md`; this plan consumes it
